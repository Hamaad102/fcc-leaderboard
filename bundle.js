...
var _ref2 = _jsx('div', {
  className: 'col-md-3'
}, void 0, _jsx('h5', {}, void 0, '#'));

var _ref3 = _jsx('div', {
  className: 'col-md-3'
}, void 0, _jsx('h5', {}, void 0, 'Camper Name'));

var _ref4 = _jsx('h5', {}, void 0, 'Points in past 30 days');

var _ref5 = _jsx('h5', {}, void 0, 'All time points');
...
var App = function (_Component) {
  ...
  _createClass(App, [{
    key: 'search',
    value: function search(URL, stateName) {
      var _this2 = this;

      fetch(URL).then(function (response) {
        return response.json();
      }).then(function (json) {
        _this2.setState(_defineProperty({}, stateName, json));
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _jsx('div', {
        ...
        onClick: function onClick() {
          return _this3.setState({ status: false });
        }
      }, void 0, _ref4), _jsx('div', {
        className: 'col-md-3',
        onClick: function onClick() {
          return _this3.setState({ status: true });
        }
      }, void 0, _ref5)), this.state.status ? life.map(function (person) {
        return _jsx('div', {
          className: 'row'
        }, void 0, _jsx('div', {
          className: 'col-md-3'
        }, void 0, life.indexOf(person) + 1), _jsx('div', {
          className: 'col-md-3'
        }, void 0, person.username), _jsx('div', {
          className: 'col-md-3'
        }, void 0, person.recent), _jsx('div', {
          className: 'col-md-3'
        }, void 0, person.alltime));
      }) : month.map(function (person) {
        return _jsx('div', {
          className: 'row'
        }, void 0, _jsx('div', {
          className: 'col-md-3'
        }, void 0, month.indexOf(person) + 1), _jsx('div', {
          className: 'col-md-3'
        }, void 0, person.username), _jsx('div', {
          className: 'col-md-3'
        }, void 0, person.recent), _jsx('div', {
